        ...
        return (
            <View style={wrapper}>
                <View style={mapContainer}>
                    <Image source={mapImg} style={{ width: '100%', height: '100%' }} />
                </View>
                <View style={infoContainer}>
                    <View style={[rowInfoContainer, { borderBottomWidth: 0 }]}>
                        <Image source={contactIcon} style={imageStyle} />
                        <Text style={infoText}>Thang Cao</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={locationIcon} style={imageStyle} />
                        <Text style={infoText}>K3 511 Nha Trang University</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 01668844581</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>cvthang56th2@gmail.com</Text>
                    </View>
                </View>
            </View>
        );
