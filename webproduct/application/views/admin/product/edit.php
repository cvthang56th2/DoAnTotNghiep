                ...
                <div class="tab_container">
                    <div class="tab_content pd0" id="tab1" style="display: block;">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span>
                                    <input id="param_date_discount" type="text" class="datepicker" style="width:100px" name="date_discount" value="<?php echo get_date($product->date_discount) ?>"/>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <strong><?php echo $product->available_quantity ?></strong>
                            </div>
                            <div class="clear"></div>
                        </div>

                        <div class="formRow">
                            <label for="param_add_quantity" class="formLeft">
                                Nhập thêm sản phẩm: 
                                <span class="req">*</span>
                            </label>
                            <div class="formRight">
                                <span>
                                    <input type="number" value="0" min="0" class="format_number" id="param_add_quantity" style="width:100px" name="add_quantity">
                                </span>
                                <span class="autocheck" name="add_quantity_autocheck"></span>
                                <div class="clear error" name="add_quantity_error"></div>
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <textarea class="editor" id="param_detail" name="detail"><?php echo $product->detail ?></textarea>
