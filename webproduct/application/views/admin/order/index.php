                        ...
                        <form class="list_filter form" action="<?php echo $action; ?>" method="get">
                            <table cellpadding="0" cellspacing="0" width="100%"><tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item"><input name="id" value="<?php
                                            if (isset($filter['order.id'])) {
                                                echo $filter['order.id'];
                                            }
                                            ?>" id="filter_id" type="text" style="width:95px;" /></td>
                                        ...
                                        <td class="item">
                                            <select name="status">
                                                <option value=""></option>
                                                <option value='0' <?php
                                                if (isset($filter['order.status']) && $filter['order.status'] == '0') {
                                                    echo 'selected';
                                                }
                                                ?>>Đợi xử lý</option>
                                                <option value='1' <?php
                                                if (isset($filter['order.status']) && $filter['order.status'] == '1') {
                                                    echo 'selected';
                                                }
                                                ?>>Đã gửi hàng</option>
                                                <option value='2' <?php
                                                if (isset($filter['order.status']) && $filter['order.status'] == '2') {
                                                    echo 'selected';
                                                }
                                                ?>>Hủy bỏ</option>
                                            </select>
                                        ...
                                        <td class="item"><input name="created" value="<?php
                                            if ($created) {
                                                echo $created;
                                            }
                                            ?>" id="filter_created" type="text" class="datepicker" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item"><input name="user" value="<?php
                                            if (isset($filter['user_id'])) {
                                                echo $filter['user_id'];
                                            }
                                            ?>" id="filter_user" class="tipS" title="Nhập mã thành viên" type="text" /></td>
                                        ...
                                        <td class="item">
                                            <select name="transaction_status">
                                                <option value=""></option>
                                                <option value='0' <?php
                                                if (isset($filter['transaction.status']) && $filter['transaction.status'] == '0') {
                                                    echo 'selected';
                                                }
                                                ?>>Đợi xử lý</option>
                                                <option value='1' <?php
                                                if (isset($filter['transaction.status']) && $filter['transaction.status'] == '1') {
                                                    echo 'selected';
                                                }
                                                ?>>Thành công</option>
                                                <option value='2' <?php
                                                if (isset($filter['transaction.status']) && $filter['transaction.status'] == '2') {
                                                    echo 'selected';
                                                }
                                                ?>>Hủy bỏ</option>
                                            </select>
                                        ...
                                        <td class="item"><input name="created_to" value="<?php
                                            if ($created_to) {
                                                echo $created_to;
                                            }
                                            ?>" id="filter_created_to" type="text" class="datepicker" /></td>
