<!-- head -->
<?php $this->load->view('admin/discount/head', $this->data) ?>
                ...
                <?php foreach ($list as $row): ?>
                    <tr class="row_<?php echo $row->id ?>">
                        ...
                        <td class="option textC">
                            ...
                            <a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('discount/edit/' . $row->id) ?>">
                                <img src="<?php echo public_url('admin/images') ?>/icons/color/edit.png">
                            </a>

                            <a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('discount/del/' . $row->id) ?>">
