                            ...
                            <table cellpadding="0" cellspacing="0" width="100%"><tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item">
                                            <select name="payment">
                                                <option value=""></option>
                                                <option value='nganluong' <?php
                                            if (isset($filter['payment']) && $filter['payment'] == 'nganluong') {
                                                echo 'selected';
                                            }
                                            ?>>Ngân lượng</option>
                                                <option value='baokim' <?php
                                                        if (isset($filter['payment']) && $filter['payment'] == 'baokim') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Bảo kim</option>
                                                <option value='dathang' <?php
                                                        if (isset($filter['payment']) && $filter['payment'] == 'dathang') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Đặt hàng</option>
                                            </select>
                                        ...
                                        <td class="item"><input name="user" value="<?php
                                                if (isset($filter['user_id'])) {
                                                    echo $filter['user_id'];
                                                        ...
                                                        ?>" id="filter_user" class="tipS" title="<?php echo lang('note_enter_user_id') ?>" type="text" /></td>
